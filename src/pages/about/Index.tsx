...
function Index() {
    return (
        <div className="flex flex-col text-center justify-center items-center ">
            <div className="flex justify-start bg-white [#14919B] rounded">
                <h1 className="text-black font-bold text-lg ml-5 mr-5">About My Meal Plan</h1>
            </div>
            <div className="flex items-center ml-80 mr-80    mb-10">
            ...
            <div className="flex justify-start bg-white [#14919B] rounded">
                <h1 className="text-black font-bold ml-5 mr-5">
                    Purpose
                </h1>
            </div>
            <div className="flex justify-center  ml-80 mr-80  mb-10">
